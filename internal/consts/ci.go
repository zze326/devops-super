...
const (
	...
	CI_CLIENT_POD_KANIKO_EXECUTOR_IMAGE     = "registry.cn-shenzhen.aliyuncs.com/zze/gcriokaniko-executor:v1.19.0"
	CI_CLIENT_POD_KANIKO_WARMER_IMAGE       = "registry.cn-shenzhen.aliyuncs.com/zze/gcriokaniko-warmer:v1.19.0"
)
